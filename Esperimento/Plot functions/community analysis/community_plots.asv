function [] = community_plots(folderName)
...
for i = 1:nMus
    ...
    CI(i,:) = mean(results.(indexes{1}),1);
    BC(i,:) = mean(results.(indexes{1}),1);
end
...
title('Surface plot di Shannon Entropy in funzione di $\varepsilon$ e $\mu$',...
